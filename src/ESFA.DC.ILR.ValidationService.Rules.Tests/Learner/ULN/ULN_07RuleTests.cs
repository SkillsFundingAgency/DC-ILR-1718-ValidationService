...
namespace ESFA.DC.ILR.ValidationService.Rules.Tests.Learner.ULN
{
    public class ULN_07RuleTests
    {
        ...
        public void ConditionMet_True()
        {
            ...
            rule.ConditionMet(25, "1", 9999999999, new DateTime(2018, 1, 1), new DateTime(2018, 1, 1), new DateTime(2017, 6, 1), new DateTime(2017, 1, 7), new DateTime(2018, 1, 7)).Should().BeTrue();
        }
        ...
        public void Validate_Errors()
        {
            ...
            var rule = new ULN_07Rule(fileDataMock.Object, validationDataMock.Object, validationErrorHandlerMock.Object);
        ...
        public void Validate_NoErrors_FundModel()
        {
            ...
            var rule = new ULN_07Rule(fileDataMock.Object, validationDataMock.Object, null);
