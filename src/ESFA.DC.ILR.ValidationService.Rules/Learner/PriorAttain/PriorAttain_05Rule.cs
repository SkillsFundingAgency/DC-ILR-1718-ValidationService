...
namespace ESFA.DC.ILR.ValidationService.Rules.Learner.PriorAttain
{
    ...
    /// </summary>
    public class PriorAttain_05Rule : AbstractRule, IRule<IMessageLearner>

    {
        ...
        {
            var validPriorAttainValues = new List<long> { 4, 5, 10, 11, 12, 13 };
        ...
        {
            return learnStartDate.HasValue && learnStartDate.Value >= new DateTime(2015, 8, 1);
        }
