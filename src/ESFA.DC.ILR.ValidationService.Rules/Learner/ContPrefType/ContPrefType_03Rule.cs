...
namespace ESFA.DC.ILR.ValidationService.Rules.Learner.ContPrefType
{
    ...
    public class ContPrefType_03Rule : AbstractRule, IRule<ILearner>
    {
        ...
        public ContPrefType_03Rule(IValidationErrorHandler validationErrorHandler, IContactPreferenceDataService contactPreferenceDataService, IDD06 dd06)
        ...
        public void Validate(ILearner objectToValidate)
        {
            ...
            {
                if (ConditionMet(contactPreference.ContPrefType,
