...
namespace ESFA.DC.ILR.ValidationService.Rules.Learner.LearnFAMType
{
    ...
    public class LearnFAMType_03Rule : AbstractRule, IRule<ILearner>
    {
        ...
        public LearnFAMType_03Rule(IValidationErrorHandler validationErrorHandler,
            ILearnFAMTypeCodeInternalDataService learnFAMTypeCodeInternalDataService, IDD06 dd06)
        ...
        public void Validate(ILearner objectToValidate)
        {
            ...
            {
                if (ConditionMet(learnerFam.LearnFAMType,
