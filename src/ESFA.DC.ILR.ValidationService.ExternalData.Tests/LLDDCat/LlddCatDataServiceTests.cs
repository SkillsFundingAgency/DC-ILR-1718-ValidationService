using ESFA.DC.ILR.ValidationService.ExternalData.LLDDCat;
...
namespace ESFA.DC.ILR.ValidationService.ExternalData.Tests.LLDDCat
{
    public class LlddCatDataServiceTests
    {
        ...
        {
            var llddCateService = new LlddCatDataService();
